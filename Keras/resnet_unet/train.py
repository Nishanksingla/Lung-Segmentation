...
def train(args):
    ...
    checkpoint = ModelCheckpoint(
        filepath, monitor='val_dice_score', verbose=1, save_best_only=True, save_weights_only=False, mode='max')
    ...
    # Define the model
    model = res_unet(root_filter_size, model_depth, n_class=1, final_activation="sigmoid", input_size=(args.height, args.width, CHANNEL))
